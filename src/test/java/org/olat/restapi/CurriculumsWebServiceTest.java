...
public class CurriculumsWebServiceTest extends OlatRestTestCase {
	...
	throws IOException, URISyntaxException, InterruptedException {
		...
		List<CurriculumVO> curriculumVoes = conn.parseList(response, CurriculumVO.class);
	...
	throws IOException, URISyntaxException, InterruptedException {
		Organisation organisation = organisationService.createOrganisation("REST Parent Organisation", "REST-p-organisation", "", defaultUnitTestOrganisation,
	...
	throws IOException, URISyntaxException, InterruptedException {
		Organisation organisation = organisationService.createOrganisation("REST Parent Organisation 3", "REST-p-3-organisation", "", defaultUnitTestOrganisation, null, JunitTestHelper.getDefaultActor());
	...
	throws IOException, URISyntaxException, InterruptedException {
		Curriculum curriculum = curriculumService.createCurriculum("REST-Del-Curriculum", "REST del Curriculum", "A curriculum deleted by REST API", false, defaultUnitTestOrganisation);
		Curriculum notDeletedCurriculum = curriculumService.createCurriculum("REST-Not-Me-Curriculum", "REST don't delete me", "A curriculum by REST API", false, defaultUnitTestOrganisation);
		dbInstance.commit();
	...
	throws IOException, URISyntaxException, InterruptedException {
		...
		Organisation organisation = organisationService.createOrganisation("REST Parent Organisation", "REST-p-organisation", "", null,
				null, JunitTestHelper.getDefaultActor());
		dbInstance.commitAndCloseSession();
	...
	throws IOException, URISyntaxException, InterruptedException {
		...
		Organisation parentOrganisation = organisationService.createOrganisation("Root curriculum organisation", "REST-curl-organisation", "", null,
				null, JunitTestHelper.getDefaultActor());
		Organisation organisationA = organisationService.createOrganisation("Organisation A", "REST-A-organisation", "", parentOrganisation,
				null, JunitTestHelper.getDefaultActor());
		Organisation organisationB = organisationService.createOrganisation("Organisation B", "REST-B-organisation", "", parentOrganisation,
				null, JunitTestHelper.getDefaultActor());
		organisationService.addMember(organisationB, curriculumManager.getIdentity(), OrganisationRoles.curriculummanager, JunitTestHelper.getDefaultActor());
		dbInstance.commitAndCloseSession();
		...
		RestConnection conn = new RestConnection(curriculumManager);
		...
		HttpRequest methodA = conn.createPost(requestA, voA, MediaType.APPLICATION_JSON);
		HttpResponse<InputStream> responsea = conn.execute(methodA);
		Assert.assertEquals(403, responsea.statusCode());
		RestConnection.consume(responsea);
		...
		HttpRequest methodB = conn.createPost(requestB, voB, MediaType.APPLICATION_JSON);
		HttpResponse<InputStream> responseB = conn.execute(methodB);
		Assert.assertEquals(200, responseB.statusCode());
	...
	throws IOException, URISyntaxException, InterruptedException {
		Organisation organisation = organisationService.createOrganisation("Curriculum org.", "curr-org", "", null,
				null, JunitTestHelper.getDefaultActor());
		...
		HttpResponse<InputStream> response = conn.execute(method);
		Assert.assertEquals(200, response.statusCode());
		List<CurriculumElementVO> elements = conn.parseList(response, CurriculumElementVO.class);
	...
	throws IOException, URISyntaxException, InterruptedException {
		...
		Curriculum curriculum = curriculumService.createCurriculum("cur-lect-1", "Curriculum for lectures", "Curriculum", false, defaultUnitTestOrganisation);
		...
		Identity participant1 = JunitTestHelper.createAndPersistIdentityAsRndUser("cur-el-lect-1", defaultUnitTestOrganisation, null);
		Identity participant2 = JunitTestHelper.createAndPersistIdentityAsRndUser("cur-el-lect-2", defaultUnitTestOrganisation, null);
		
		Identity author = JunitTestHelper.createAndPersistIdentityAsRndUser("cur-el-lect-auth");
		RepositoryEntry entryLecture1 = JunitTestHelper.createRandomRepositoryEntry(author, defaultUnitTestOrganisation);
		RepositoryEntry entryLecture2 = JunitTestHelper.createRandomRepositoryEntry(author, defaultUnitTestOrganisation);
		...
		List<LectureBlockStatisticsVO> statisticsVoes = conn.parseList(response, LectureBlockStatisticsVO.class);
	...
	throws IOException, URISyntaxException, InterruptedException {
		...
		// curriculum with 2 courses
		Curriculum curriculum = curriculumService.createCurriculum("cur-lectures-2", "Curriculum for lectures", "Curriculum", false, defaultUnitTestOrganisation);
		CurriculumElement element = curriculumService.createCurriculumElement("Element-for-lectures",
				...
				CurriculumCalendars.disabled, CurriculumLectures.disabled, CurriculumLearningProgress.disabled,
				curriculum);
		Identity participant = JunitTestHelper.createAndPersistIdentityAsRndUser("cur-el-lectures-part", defaultUnitTestOrganisation, null);
		Identity author = JunitTestHelper.createAndPersistIdentityAsRndUser("cur-el-lectures-auth", defaultUnitTestOrganisation, null);
		RepositoryEntry entryLecture1 = JunitTestHelper.createRandomRepositoryEntry(author, defaultUnitTestOrganisation);
		RepositoryEntry entryLecture2 = JunitTestHelper.createRandomRepositoryEntry(author, defaultUnitTestOrganisation);
		...
		LectureBlockStatisticsVO statisticsVo = conn.parse(response, LectureBlockStatisticsVO.class);
