...
public class DocEditorWebServiceTest extends OlatRestTestCase {
	...
	throws IOException, URISyntaxException, InterruptedException {
		...
		Access access1 = accessDao.createAccess(randomMetadata(), identity, randomAppName, Mode.EDIT, true, true, false, new Date());
		Access access2 = accessDao.createAccess(randomMetadata(), identity2, randomAppName, Mode.VIEW, false, true, false, new Date());
